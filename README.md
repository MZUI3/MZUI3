...
* MobileViT 기반 경량 분류기 성능 개선 연구
* 초기 Attention Feature 재사용 구조 제안
...
* Small Dataset 환경에서의 Vision Transformer 성능 개선
* Residual Block 기반 Inductive Bias 적용
* CIFAR-10 / CIFAR-100 성능 향상
