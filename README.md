...
| | |
|---|---|
| **Tech Stack** | Java 17 · Spring Boot · Spring Security(JWT) · JPA/H2 · React 19 · OpenAI API · Docker · AWS EKS · CodePipeline/CodeBuild · ECR · RDS(MySQL) · CloudWatch · SNS |
| **Key Contributions** | REST API 서버 및 JWT 인증/인가 구현 · 도서·리뷰 CRUD 및 OpenAI 표지·태그 생성 기능 개발 · EKS 기반 CI/CD 파이프라인 구축 · HPA 오토스케일링·Rolling Update 구현 · H2 → RDS 전환 및 CloudWatch/SNS 모니터링 체계 구축 |
